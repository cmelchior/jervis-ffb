    ...
    sendMethod.instrument(object : ExprEditor() {
        override fun edit(m: MethodCall) {
            if (m.methodName.equals("toJsonValue")) {
                m.replace("\$_ = \$proceed($$); dk.ilios.fumbblclient.FumbblDebugger.handleClientMessage(\$_);")
            }
        }
    })
    ...
    onMessageMethod.instrument(object : ExprEditor() {
        override fun edit(m: MethodCall) {
            if (m.methodName.equals("readFrom")) {
                m.replace("\$_ = \$proceed($$); dk.ilios.fumbblclient.FumbblDebugger.handleServerMessage(\$_);")
            }
        }
    })
