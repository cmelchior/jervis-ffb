...
class Horns(
    ...
    override val resetAt: Duration = Duration.PERMANENT // Does this ever counts as "used". Probably not since it works every time.
    ...
    data object Factory: SkillFactory {
        override val value: Int? = null
        override fun createSkill(isTemporary: Boolean, expiresAt: Duration): Skill = Horns(isTemporary, expiresAt)
    }
}
