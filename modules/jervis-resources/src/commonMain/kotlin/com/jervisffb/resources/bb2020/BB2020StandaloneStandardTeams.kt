...
object BB2020StandaloneStandardTeams {
    private val rules = StandardBB2020Rules()
    val defaultTeams = mapOf(
        "human-starter-team-bb2020.jrt" to buildTeamFile {
        ...
        "lizardmen-starter-team-bb2020.jrt" to buildTeamFile {
            metadata = JervisMetaData(FILE_FORMAT_VERSION)
        ...
        "skaven-starter-team-bb2020.jrt" to buildTeamFile {
            metadata = JervisMetaData(FILE_FORMAT_VERSION)
        ...
        "khorne-starter-team-bb2020.jrt" to buildTeamFile {
            metadata = JervisMetaData(FILE_FORMAT_VERSION)
