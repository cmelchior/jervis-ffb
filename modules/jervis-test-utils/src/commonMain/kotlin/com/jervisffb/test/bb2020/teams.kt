...
fun humanTeamAwayBB2020(rules: Rules): Team {
    return teamBuilder(rules, HUMAN_TEAM_TEST_BB2020) {
...
fun lizardMenAwayTeam(rules: Rules): Team {
    return teamBuilder(rules, LIZARDMEN_TEAM_TEST_BB2020) {
        coach = Coach(CoachId("away-coach"), "AwayCoach")
        name = "AwayTeam"
...
fun createDefaultHomeTeamBB2020(rules: Rules): Team {
    return teamBuilder(rules, HUMAN_TEAM_TEST_BB2020) {
...
fun createDefaultGameStateBB2020(
    rules: Rules,
    homeTeam: Team = createDefaultHomeTeamBB2020(rules),
    awayTeam: Team = humanTeamAwayBB2020(rules)
): Game {
