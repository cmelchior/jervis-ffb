...
fun humanTeamAwayBB2025(rules: Rules): Team {
...
fun lizardMenAwayTeam(rules: Rules): Team {
    return teamBuilder(rules, LIZARDMEN_TEAM_TEST_BB2025) {
        coach = Coach(CoachId("away-coach"), "AwayCoach")
        name = "AwayTeam"
...
fun createDefaultHomeTeamBB2025(rules: Rules): Team {
    return teamBuilder(rules, HUMAN_TEAM_TEST_BB2025) {
...
fun createDefaultGameStateBB2025(
    rules: Rules,
