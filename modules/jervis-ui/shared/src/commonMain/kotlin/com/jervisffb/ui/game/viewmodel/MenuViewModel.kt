...
enum class Feature(val settingsKey: String) {
    ...
    SELECT_BLOCK_DIE_IF_ONLY_OPTION(SettingsKeys.JERVIS_AUTO_ACTION_ACTIONS_SELECT_BLOCK_DIE_IF_ONE_OPTION_VALUE),
    ...
    ALWAYS_USE_TWO_HEADS(SettingsKeys.JERVIS_AUTO_ACTION_SKILLS_ALWAYS_USE_TWO_HEADS_VALUE),
