...
fun createDefaultBB2020HomeTeam(rules: Rules): Team {
    return teamBuilder(rules, HUMAN_TEAM_BB2020) {
        ...
        addPlayer(PlayerId("H5"), "Thrower-5-H", PlayerNo(5), HUMAN_THROWER)
        ...
        addPlayer(PlayerId("H8"), "Lineman-8-H", PlayerNo(8), HUMAN_LINEMAN)
        addPlayer(PlayerId("H9"), "Lineman-9-H", PlayerNo(9), HUMAN_LINEMAN)
...
fun createDefaultBB2025HomeTeam(rules: Rules): Team {
    val team = teamBuilder(rules, HUMAN_TEAM_BB2025) {
        ...
        addPlayer(PlayerId("H8"), "Lineman-8-H", PlayerNo(8), com.jervisffb.resources.bb2025.HUMAN_LINEMAN)
        addPlayer(PlayerId("H9"), "Lineman-9-H", PlayerNo(9), com.jervisffb.resources.bb2025.HUMAN_LINEMAN)
