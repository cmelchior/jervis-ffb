...
import com.jervisffb.ui.screen.fumbbl.FumbblScreenModel.LoginDialogAction
import com.jervisffb.ui.view.JervisTheme
import com.jervisffb.ui.view.JervisTheme.buttonTextColor
...
private fun ColumnScope.LogOutDialogContent(
    ...
    Row(
        ...
        JervisButton(
            text = "Cancel",
            onClick = { viewModel.loginDialogAction(LoginDialogAction.CANCEL) },
        ...
        JervisButton(
            text = "Logout",
            onClick = { viewModel.loginDialogAction(LoginDialogAction.LOGOUT) },
            buttonColor = JervisTheme.rulebookBlue,
            textColor = buttonTextColor,
        )
    }
...
private fun ColumnScope.LogInDialogContent(viewModel: FumbblScreenModel, dialogColor: Color, textColor: Color, inputDialogColors: @Composable ((String) -> TextFieldColors)) {
    ...
    Row(
        ...
        JervisButton(
            text = "Login",
            onClick = { viewModel.loginDialogAction(LoginDialogAction.LOGIN) },
            buttonColor = JervisTheme.rulebookBlue,
            textColor = buttonTextColor,
