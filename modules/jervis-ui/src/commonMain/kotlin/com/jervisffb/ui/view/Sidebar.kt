...
@Composable
fun Sidebar(
    vm: com.jervisffb.ui.viewmodel.SidebarViewModel,
    modifier: Modifier,
) {
            ...
            Box(modifier = modifier.aspectRatio(vm.aspectRatio).fillMaxSize()) {
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    Box(modifier = Modifier.fillMaxWidth()) {
                        ...
                        when (view) {
                            com.jervisffb.ui.viewmodel.SidebarView.RESERVES -> Reserves(vm.reserves()) {
                                vm.hoverExit()
                            }
                            com.jervisffb.ui.viewmodel.SidebarView.INJURIES ->
                                Injuries(
                                    vm.knockedOut(),
                                    vm.badlyHurt(),
                                    vm.seriousInjuries(),
