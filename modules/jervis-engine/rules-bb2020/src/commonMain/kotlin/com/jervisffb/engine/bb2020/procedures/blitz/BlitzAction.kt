package com.jervisffb.engine.bb2020.procedures.blitz
    ...
    object ResolveBlock : ParentNode() {
        override fun onEnterNode(state: Game, rules: Rules): Command {
            ...
            return when (context.blockType!!) {
                BlockType.CHAINSAW -> INVALID_GAME_STATE("Not supported yet")
                BlockType.CHOMP -> INVALID_GAME_STATE("Not supported yet")
                BlockType.MULTIPLE_BLOCK -> TODO()
                BlockType.BREATHE_FIRE -> INVALID_GAME_STATE("Not supported yet")
                BlockType.PROJECTILE_VOMIT -> INVALID_GAME_STATE("Not supported yet")
                BlockType.STAB -> INVALID_GAME_STATE("Not supported yet")
                BlockType.STANDARD -> {
                    AddContext(
                        BlockContext(
                            context.attacker,
        ...
        override fun getChildProcedure(state: Game, rules: Rules): Procedure {
            ...
            return when (context.blockType!!) {
                BlockType.CHAINSAW -> INVALID_GAME_STATE("Not supported yet")
                BlockType.CHOMP -> INVALID_GAME_STATE("Not supported yet")
                BlockType.MULTIPLE_BLOCK -> INVALID_GAME_STATE("Not supported yet")
                BlockType.BREATHE_FIRE -> INVALID_GAME_STATE("Not supported yet")
                BlockType.PROJECTILE_VOMIT -> INVALID_GAME_STATE("Not supported yet")
                BlockType.STAB -> INVALID_GAME_STATE("Not supported yet")
