package com.jervisffb.engine.bb2020.procedures.actions.block.multipleblock
...
object MultipleBlockRerollDice: Procedure() {
    ...
    override fun isValid(state: Game, rules: Rules) = state.assertContext<BB2020MultipleBlockContext>()
