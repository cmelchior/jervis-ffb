...
/**
 * Class testing usage of the [com.jervisffb.engine.common.procedures.Catch] skill
 *
 * See page 75 in the rulebook for the skill.
 * See page 51 in the rulebook for the catching description.
 */
class CatchSkillTests: JervisGameBB2020Test() {
    ...
    fun catchDeviatedBall() {
        controller.rollForward(
            ...
            *setupPlayer("A10".playerId, PitchCoordinate(15, 7)),
            EndSetup,
            *defaultKickOffHomeTeam(
                placeKick = PitchSquareSelected(16, 7),
            ...
            PlayerActionSelected(PlayerStandardActionType.PASS),
            PassTypeSelected(PassType.STANDARD),
            PitchSquareSelected(15, 1), // Throw Short Pass to player with Catch
