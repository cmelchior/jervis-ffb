...
/**
 * Class testing usage of the [StandFirm] skill.
 */
class StandFirmTests: JervisGameBB2025Test() {
    ...
    @Test
    fun preventGrabAndSidestep() {
        val attacker = state.getPlayerById("A1".playerId)
        val defender = state.getPlayerById("H1".playerId)
        defender.apply {
            addSkill(SkillType.STAND_FIRM)
    ...
    fun frenzyCanHitTwice() {
        ...
        controller.rollForward(
            ...
            *standardBlock("H1", 3.dblock),
            ...
            DiceRollResults(3.dblock), // 2nd Block from Frenzy
            NoRerollSelected(),
