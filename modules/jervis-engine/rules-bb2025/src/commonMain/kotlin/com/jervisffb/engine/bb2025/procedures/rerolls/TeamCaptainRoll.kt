...
object TeamCaptainRoll: D6WithRerollProcedure() {
    ...
    override fun isValid(state: Game, rules: Rules) = state.assertContext<TeamCaptainRollContext>()
    override fun getActionOwner(state: Game): Player = state.getContext<TeamCaptainRollContext>().player
