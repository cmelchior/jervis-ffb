 ...
 * indexes.
 */
data class MultipleBlockContext2025(
    val attacker: Player,
    ...
    fun copyAndUpdateHasAcceptedResult(index: Int, hasAcceptedResult: Boolean): MultipleBlockContext2025 {
        return when (index) {
    ...
    fun addInjuryReferenceForPlayer(player: Player, injuryContext: RiskingInjuryContext): Command {
        return when (player) {
            ...
            defender1 -> SetContextProperty(MultipleBlockContext2025::defender1InjuryContext, this, injuryContext)
            defender2 -> SetContextProperty(MultipleBlockContext2025::defender2InjuryContext, this, injuryContext)
     ...
     * This also c
     */
    fun copyAndSetBlockTypeForActiveDefender(type: BlockType): MultipleBlockContext2025 {
    ...
    fun copyAndKnockDownActiveDefender(knockedDown: Boolean): MultipleBlockContext2025 {
        return when (activeDefender) {
