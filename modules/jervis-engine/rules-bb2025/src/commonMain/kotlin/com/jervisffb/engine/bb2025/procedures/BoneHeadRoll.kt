...
/**
 * Procedure for rolling for Bone Head in BB2025.
 */
object BoneHeadRoll : D6WithPlayerRerollProcedure() {
    ...
    override fun onExitRollProcedure(state: Game, rules: Rules): Command {
        ...
        return buildCompositeCommand {
            ...
            if (!context.isSuccess) {
                ...
                getResetChompedStateCommands(
                    context.player,
                    context.player.location,
                    forceRemoveChompedByChomper = true,
                )?.let(::add)
                addAll(
