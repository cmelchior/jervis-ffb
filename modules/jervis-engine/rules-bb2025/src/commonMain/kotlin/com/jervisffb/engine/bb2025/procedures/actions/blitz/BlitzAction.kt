package com.jervisffb.engine.bb2025.procedures.actions.blitz
...
import com.jervisffb.engine.bb2025.procedures.actions.block.BreatheFireStep
import com.jervisffb.engine.bb2025.procedures.actions.block.ChainsawBlockStep
import com.jervisffb.engine.bb2025.procedures.actions.block.ChompContext
import com.jervisffb.engine.bb2025.procedures.actions.block.ChompStep
...
import com.jervisffb.engine.common.procedures.actions.block.ProjectileVomitContext
import com.jervisffb.engine.common.procedures.actions.block.ProjectileVomitStep
import com.jervisffb.engine.common.procedures.actions.block.StabContext
import com.jervisffb.engine.common.procedures.actions.block.StabStep
...
object BlitzAction : Procedure() {
    ...
    object ResolveFallingOverBeforeBlock: ParentNode() {
        ...
        override fun getChildProcedure(state: Game, rules: Rules): Procedure = rules.fallingOverStep
        override fun onExitNode(state: Game, rules: Rules): Command {
    ...
    object SelectBlockType : ActionNode() {
        ...
        override fun getAvailableActions(state: Game, rules: Rules): List<GameActionDescriptor> {
            val attacker = state.getContext<BlitzActionContext>().attacker
            val availableBlockTypes = rules.getAvailableBlockType(attacker, true)
            return buildList {
    ...
    object ResolveBlock : ParentNode() {
        ...
        override fun getChildProcedure(state: Game, rules: Rules): Procedure {
            ...
            return when (context.blockType!!) {
                ...
                BlockType.STANDARD -> rules.standardBlockStep
            }
        }
        override fun onExitNode(state: Game, rules: Rules): Command {
            // If player is not standing on the pitch after the move, it is a turn over,
            ...
            val hasBlocked = when (context.blockType) {
                ...
                null -> INVALID_GAME_STATE("Should never be null")
            }
