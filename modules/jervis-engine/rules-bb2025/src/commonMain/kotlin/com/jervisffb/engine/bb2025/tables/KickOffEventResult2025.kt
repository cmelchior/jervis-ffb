 ...
 *
 * See [KickOffEventResultCommon] for results shared with BB2020.
 */
enum class KickOffEventResult2025(
    ...
    CHEERING_FANS(description = "Cheering Fans", CheeringFans2025, duration = Duration.IMMEDIATE),
