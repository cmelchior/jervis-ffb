...
import com.jervisffb.engine.bb2025.skills.Accurate
import com.jervisffb.engine.bb2025.skills.AlwaysHungry
import com.jervisffb.engine.bb2025.skills.AnimalSavagery
import com.jervisffb.engine.bb2025.skills.ArmBar
import com.jervisffb.engine.bb2025.skills.BigHand
import com.jervisffb.engine.bb2025.skills.Block
import com.jervisffb.engine.bb2025.skills.BloodLust
import com.jervisffb.engine.bb2025.skills.BoneHead
import com.jervisffb.engine.bb2025.skills.Brawler
import com.jervisffb.engine.bb2025.skills.BreakTackle
import com.jervisffb.engine.bb2025.skills.BreatheFire
import com.jervisffb.engine.bb2025.skills.Bullseye
import com.jervisffb.engine.bb2025.skills.Cannoneer
import com.jervisffb.engine.bb2025.skills.CatchSkill
import com.jervisffb.engine.bb2025.skills.Chainsaw
import com.jervisffb.engine.bb2025.skills.Claws
import com.jervisffb.engine.bb2025.skills.CloudBurster
import com.jervisffb.engine.bb2025.skills.Dauntless
...
import com.jervisffb.engine.bb2025.skills.DivingCatch
import com.jervisffb.engine.bb2025.skills.DivingTackle
import com.jervisffb.engine.bb2025.skills.Dodge
import com.jervisffb.engine.bb2025.skills.ExtraArms
import com.jervisffb.engine.bb2025.skills.EyeGouge
import com.jervisffb.engine.bb2025.skills.Fend
import com.jervisffb.engine.bb2025.skills.FoulAppearance
import com.jervisffb.engine.bb2025.skills.Frenzy
import com.jervisffb.engine.bb2025.skills.Fumblerooski
import com.jervisffb.engine.bb2025.skills.GiveAndGo
import com.jervisffb.engine.bb2025.skills.Grab
import com.jervisffb.engine.bb2025.skills.Guard
import com.jervisffb.engine.bb2025.skills.HailMaryPass
import com.jervisffb.engine.bb2025.skills.Hatred
import com.jervisffb.engine.bb2025.skills.HitAndRun
import com.jervisffb.engine.bb2025.skills.Horns
import com.jervisffb.engine.bb2025.skills.HypnoticGaze
import com.jervisffb.engine.bb2025.skills.Insignificant
import com.jervisffb.engine.bb2025.skills.IronHardSkin
import com.jervisffb.engine.bb2025.skills.Juggernaut
import com.jervisffb.engine.bb2025.skills.JumpUp
import com.jervisffb.engine.bb2025.skills.Kick
import com.jervisffb.engine.bb2025.skills.Leader
import com.jervisffb.engine.bb2025.skills.Leap
import com.jervisffb.engine.bb2025.skills.LethalFlight
...
import com.jervisffb.engine.bb2025.skills.NoBall
import com.jervisffb.engine.bb2025.skills.Pass
import com.jervisffb.engine.bb2025.skills.PileDriver
import com.jervisffb.engine.bb2025.skills.Pogo
import com.jervisffb.engine.bb2025.skills.PrehensileTail
import com.jervisffb.engine.bb2025.skills.Pro
import com.jervisffb.engine.bb2025.skills.ProjectileVomit
import com.jervisffb.engine.bb2025.skills.Punt
import com.jervisffb.engine.bb2025.skills.PutTheBootIn
import com.jervisffb.engine.bb2025.skills.QuickFoul
import com.jervisffb.engine.bb2025.skills.ReallyStupid
import com.jervisffb.engine.bb2025.skills.Regeneration
import com.jervisffb.engine.bb2025.skills.RightStuff
import com.jervisffb.engine.bb2025.skills.SafePairOfHands
import com.jervisffb.engine.bb2025.skills.SafePass
...
import com.jervisffb.engine.bb2025.skills.Sprint
import com.jervisffb.engine.bb2025.skills.Stab
import com.jervisffb.engine.bb2025.skills.StandFirm
import com.jervisffb.engine.bb2025.skills.SteadyFooting
import com.jervisffb.engine.bb2025.skills.StripBall
...
import com.jervisffb.engine.bb2025.skills.Swoop
import com.jervisffb.engine.bb2025.skills.Tackle
import com.jervisffb.engine.bb2025.skills.TakeRoot
import com.jervisffb.engine.bb2025.skills.Taunt
import com.jervisffb.engine.bb2025.skills.Tentacles
import com.jervisffb.engine.bb2025.skills.ThickSkull
import com.jervisffb.engine.bb2025.skills.ThrowTeamMate
import com.jervisffb.engine.bb2025.skills.Timmmber
import com.jervisffb.engine.bb2025.skills.Titchy
import com.jervisffb.engine.bb2025.skills.TwoHeads
import com.jervisffb.engine.bb2025.skills.UnchannelledFury
import com.jervisffb.engine.bb2025.skills.Unsteady
import com.jervisffb.engine.bb2025.skills.VeryLongLegs
import com.jervisffb.engine.bb2025.skills.Wrestle
import com.jervisffb.engine.bb2025.specialrules.SneakiestOfTheLot
...
@Serializable
class SkillSettings2025: SkillSettings() {
    override fun initializeSkillCache() {
        ...
        SkillType.entries.forEach { type ->
            when (type) {
                ...
                // Star Player special rules that are not implemented yet.
                SkillType.ALL_YOU_CAN_EAT,
                SkillType.A_SNEAKY_PAIR,
                SkillType.BALEFUL_HEX,
                SkillType.BEER_BARREL_BASH,
                SkillType.BLACK_INK,
                SkillType.BLASTIN_SOLVES_EVERYTHING,
                SkillType.BLAST_IT,
                SkillType.BLIND_RAGE,
                SkillType.BOUNDING_LEAP,
                SkillType.CATCH_OF_THE_DAY,
                SkillType.CONSUMMATE_PROFESSIONAL,
                SkillType.CRUSHING_BLOW,
                SkillType.DWARFEN_GRIT,
                SkillType.DWARVEN_SCOURGE,
                SkillType.EXCUSE_ME_ARE_YOU_A_ZOAT,
                SkillType.FRENZIED_RUSH,
                SkillType.FURIOUS_OUTBURST,
                SkillType.FURY_OF_THE_BLOOD_GOD,
                SkillType.GORED_BY_THE_BULL,
                SkillType.HALFLING_LUCK,
                SkillType.ILL_BE_BACK,
                SkillType.ILL_CARRY_YOU,
                SkillType.INCORPOREAL,
                SkillType.INDOMITABLE,
                SkillType.KABOOM,
                SkillType.KICK_EM_WHILE_THEYRE_DOWN,
                SkillType.KRUMP_AND_SMASH,
                SkillType.LOOK_INTO_MY_EYES,
                SkillType.LORD_OF_CHAOS,
                SkillType.MASTER_ASSASSIN,
                SkillType.MAXIMUM_CARNAGE,
                SkillType.MESMERISING_DANCE,
                SkillType.OLD_PRO,
                SkillType.PRIMAL_SAVAGERY,
                SkillType.PUMP_UP_THE_CROWD,
                SkillType.PUTRID_REGURGITATION,
                SkillType.QUICK_BITE,
                SkillType.RAIDING_PARTY,
                SkillType.RAM,
                SkillType.RELIABLE,
                SkillType.SAVAGE_BLOW,
                SkillType.SAVAGE_MAULING,
                SkillType.SHOT_TO_NOTHING,
                SkillType.SLASHING_NAILS,
                SkillType.SLAYER,
                SkillType.STAR_OF_THE_SHOW,
                SkillType.STRONG_PASSING_GAME,
                SkillType.SWIFT_AS_THE_BREEZE,
                SkillType.TASTY_MORSEL,
                SkillType.THE_BALLISTA,
                SkillType.THE_FLASHING_BLADE,
                SkillType.THINKING_MANS_TROLL,
                SkillType.TOXIN_CONNOISSEUR,
                SkillType.TREACHEROUS,
                SkillType.UNSTOPPABLE_MOMENTUM,
                SkillType.VICIOUS_VINES,
                SkillType.WATCH_OUT,
                SkillType.WHIRLING_DERVISH,
                SkillType.WISDOM_OF_THE_WHITE_DWARF,
                SkillType.WOODLAND_FURY,
                SkillType.WORKING_IN_TANDEM,
                SkillType.YOINK,
