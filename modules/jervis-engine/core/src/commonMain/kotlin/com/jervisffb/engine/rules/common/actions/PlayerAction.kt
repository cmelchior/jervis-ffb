...
/**
 * Wrapper representing a player action. This can either be a normal or special
 * action.
 */
@Serializable
data class PlayerAction(
    val name: String,
    val type: ActionType,
    // Even if this action is of a given [type]. It will be treated as this type
    // when counting actions. This is mostly relevant for Special Actions, like
    // Chainsaw, that counts as Block.
