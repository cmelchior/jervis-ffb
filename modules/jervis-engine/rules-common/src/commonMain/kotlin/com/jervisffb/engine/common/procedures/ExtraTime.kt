...
import com.jervisffb.engine.common.reports.ReportGoingIntoSuddenDeath
import com.jervisffb.engine.common.reports.ReportStartingDrive
import com.jervisffb.engine.common.reports.ReportStartingExtraTime
...
object ExtraTime : Procedure() {
    ...
    override fun onExitProcedure(state: Game, rules: Rules): Command {
        ...
        val resetCommands = getResetTeamTemporaryModifiersCommands(state, Duration.END_OF_HALF)
        return compositeCommandOf(
            *resetCommands
        )
    }
