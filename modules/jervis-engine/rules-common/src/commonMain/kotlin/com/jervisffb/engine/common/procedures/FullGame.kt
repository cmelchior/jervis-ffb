...
import com.jervisffb.engine.common.reports.ReportClosingGame
import com.jervisffb.engine.common.reports.ReportGameResult
import com.jervisffb.engine.common.reports.ReportGoingIntoExtraTime
import com.jervisffb.engine.common.reports.ReportStartingGame
    ...
    object RunGame : ParentNode() {
        ...
        override fun onExitNode(state: Game, rules: Rules): Command {
            return if (state.halfNo < rules.halfsPrGame) {
                ...
                val resetCommands = getResetTeamTemporaryModifiersCommands(state, Duration.END_OF_GAME)
