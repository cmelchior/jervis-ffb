package com.jervisffb.engine.common.procedures.actions.pass
...
object PassAction : Procedure() {
    ...
    object ResolveStandardThrow : ParentNode() {
        ...
        override fun getChildProcedure(state: Game, rules: Rules): Procedure = rules.passStep
    }
    ...
    object ResolveHailMaryThrow : ParentNode() {
        ...
        override fun getChildProcedure(state: Game, rules: Rules): Procedure = rules.hailMaryPassStep
    }
