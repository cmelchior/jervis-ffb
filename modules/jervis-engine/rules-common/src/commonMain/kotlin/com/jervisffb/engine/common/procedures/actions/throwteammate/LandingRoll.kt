package com.jervisffb.engine.common.procedures.actions.throwteammate
 ...
 */
object LandingRoll : D6WithPlayerRerollProcedure() {
    ...
    override fun getActionOwner(state: Game): Player = state.getContext<LandingRollContext>().landingPlayer
