...
object JervisSerialization {
    ...
    // This property combines serializer modules from all modules the `publication` module exposes.
    // Eventually, it would be nice to make this something you can configure at runtime, but for now, this should be fine.
    val jervisEngineSerializerModule = coreSerializerModule + commonSerializerModule + bb2020SerializerModule + bb2025SerializerModule
    ...
    fun serializeGameStateToJson(
        ...
        val fileData =
            JervisGameFile(
                ...
                JervisGameData(
                    homeTeam = jsonFormat.encodeToJsonElement(controller.initialHomeTeamState!!),
                    awayTeam = jsonFormat.encodeToJsonElement(controller.initialAwayTeamState!!),
