...
data class FieldCoordinate(
    ...
    fun move(
        ...
        var dx = 0
        when (d) {
            dk.ilios.jervis.fumbbl.model.Direction.NORTH -> dy = -1
            dk.ilios.jervis.fumbbl.model.Direction.NORTHEAST -> {
                dx = 1
                dy = -1
            }
            dk.ilios.jervis.fumbbl.model.Direction.EAST -> dx = 1
            dk.ilios.jervis.fumbbl.model.Direction.SOUTHEAST -> {
                dx = 1
                dy = 1
            }
            dk.ilios.jervis.fumbbl.model.Direction.SOUTH -> dy = 1
            dk.ilios.jervis.fumbbl.model.Direction.SOUTHWEST -> {
                dx = -1
                dy = 1
            }
            dk.ilios.jervis.fumbbl.model.Direction.WEST -> dx = -1
            dk.ilios.jervis.fumbbl.model.Direction.NORTHWEST -> {
                dx = -1
                dy = -1
            }
        }
