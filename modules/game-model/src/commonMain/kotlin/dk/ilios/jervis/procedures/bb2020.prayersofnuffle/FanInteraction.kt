...
/**
 * Procedure for handling the Prayer of Nuffle "Fan Interaction" as described on page 39
 * of the rulebook.
 */
    ...
    object ApplyEvent : ComputationNode() {
        ...
        override fun apply(
            ...
            return compositeCommandOf(
                SimpleLogEntry("Do Fan interaction!", category = LogCategory.GAME_PROGRESS),
                ExitProcedure(),
            )
        }
    }
