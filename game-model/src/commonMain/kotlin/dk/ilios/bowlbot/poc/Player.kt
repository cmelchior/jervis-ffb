package dk.ilios.bowlbot.poc//package dk.ilios.bowlbot.controller
//
...
//    val enterProcedureEntry = SimpleLogEntry(message = "Load procedure: ${getChildProcedure().name()}[${getChildProcedure().initialState.name()}]")
//    override fun execute(state: GameState, controller: GameController) {
...
//            val currentPlayer = when (dieRoll.result) {
...
//) {
//    // TODO I dont think we need to track the procedure here.
//    val fsmHistory: ArrayDeque<ProcedureState> = ArrayDeque()
...
//                val reportAction = ReportLog(SimpleLogEntry(LogCategory.STATE_MACHINE, "Selected action: $selectedAction"))
//                reportAction.execute(state, this)
//                commands.add(reportAction)
//                val command = currentNode.applyAction(selectedAction, state)
//                commands.add(command) // Store list of executed commands
...
//            val currentState: Node = fsmHistory.first().currentNode()
//            processNode(currentState)
//        }
//    }
//
//    private fun setInitialProcedure(procedure: Procedure) {
//        addLog(SimpleLogEntry(LogCategory.STATE_MACHINE, "Set initial procedure: ${procedure.name()}[${procedure.initialState.name()}]"))
...
//        fsmHistory.addFirst(ProcedureState(procedure, procedure.initialState))
//    }
//
//    fun addProcedure(procedure: ProcedureState) {
//        fsmHistory.addFirst(procedure)
//    }
//
//    fun removeProcedure(): ProcedureState {
//        return fsmHistory.removeFirst()
//    }
//
//    fun currentProcedure(): ProcedureState? = fsmHistory.firstOrNull()
//
//    fun addNode(nextState: Node) {
//        fsmHistory.first().addNode(nextState)
//    }
//
//    fun removeNode() {
//        fsmHistory.first().removeLast()
//    }
//
